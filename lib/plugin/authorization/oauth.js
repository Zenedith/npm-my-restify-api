...
exports.oauth = function (req) {
  ...
  try {
    ...
    throw new UnauthorizedError('Unauthorized client');
  }
  ...
  context.user = function () {
    ...
    try {
      ...
      throw new UnauthorizedError('Unauthorized user token');
    }
  };
  ...
  context.client = function (client) {
    ...
    throw new UnauthorizedError('Invalid oauth authorization clientId');
  };
  ...
  context.scope = function (scope, userMessage) {
    ...
    throw new ForbiddenError('Invalid oauth authorization scope.', userMessage);
  };
